						...
						<div class="table-content table-responsive">
							<table>
								...
								<tbody>
									...
									<tr>
										<td class="product-remove"><a href="{{route('cart.destory', $item->id)}}"><i class="pe-7s-close"></i></a></td>
										<td class="product-thumbnail">
											<a href="{{route('products.show', $item->id)}}"><img class='img-thumbnail' src="{{$item->image}}" alt="" ></a>
