                ...
                <div class="menu-style-3 menu-hover text-center">
                    <nav>
                        <ul>
                            ...
                            <li><a href="blog.html">blog <i class="pe-7s-angle-down"></i> <span class="sticker-new">hot</span></a></li>
...
{{-- 			<div class='col-4'> --}}
{{-- 				<div class='card'> --}}
{{-- 					<img class='card-img-top img-rounded' src='{{$product->cover_img}}' alt='Card image cap' height='300'> --}}
{{-- 					<div class='card-body'> --}}
